...
//                Connection con = DriverManager.getConnection("jdbc:mysql://127.5.169.2:3306/online", "adminSQzmqRN", "YXBUrxiC7yWn");//one
 Connection con = DriverManager.getConnection("jdbc:mysql://127.8.43.130:3306/datatransmission2", "adminubbC7XL", "YI9-_1R-T5WC");
