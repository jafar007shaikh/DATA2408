...
//            con = DriverManager.getConnection("jdbc:mysql:/127.8.183.130:3306/online_tpa", "adminghREbsQ", "zUEgaLYYB3Ba");//three
            con = DriverManager.getConnection("jdbc:mysql://127.9.25.130:3306/datatransmission3", "adminMAcwPce", "cEUa3DGgf5Ng");
        } catch (Exception ex) {
            ex.printStackTrace();
        }
        return con;
